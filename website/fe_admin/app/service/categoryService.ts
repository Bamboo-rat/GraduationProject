...
class CategoryService {
  ...
  async getAllCategories(
    ...
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ t£i danh sách danh måc');
    }
  }
  ...
  async getCategoryById(categoryId: string): Promise<Category> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ t£i thông tin danh måc');
    }
  }
  ...
  async createCategory(request: CategoryRequest): Promise<Category> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ t¡o danh måc');
    }
  }
  ...
  async updateCategory(categoryId: string, request: CategoryRequest): Promise<Category> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ c­p nh­t danh måc');
    }
  }
  ...
  async deleteCategory(categoryId: string): Promise<void> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ xóa danh måc');
    }
  }
  ...
  async toggleActive(categoryId: string, active: boolean): Promise<Category> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Không thÃ c­p nh­t tr¡ng thái danh måc');
    }
  }
