      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Latitude */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Latitude (Vĩ độ)</label>
              <input
                type="number"
                name="newLatitude"
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Hiện tại: {store.latitude || 'Chưa có'}
              </p>
            </div>

            {/* Longitude */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Longitude (Kinh độ)</label>
              <input
                type="number"
                name="newLongitude"
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Hiện tại: {store.longitude || 'Chưa có'}
              </p>
            </div>
          </div>
