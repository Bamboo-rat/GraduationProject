        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          {currentStep === 4 && (
            <form onSubmit={handleStep4Submit} className="space-y-4">
              ...
              {/* Latitude & Longitude - Auto-filled from address search */}
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                  ...
                  <input
                    ...
                    required
                    readOnly
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-gray-50 text-gray-600 outline-none cursor-not-allowed"
