...
export function AuthProvider({ children }: { children: ReactNode }) {
        ...
        if (authService.isAuthenticated()) {
          ...
          if (userInfo) {
            ...
            try {
              ...
              // Cập nhật lại thông tin mới nhất (không gọi method nội bộ của service)
              try {
   ...
   *
   * Lưu ý: authService.getCurrentUser() trả về UserInfo.
   * Nếu bạn muốn lấy thông tin chi tiết (SupplierResponse),
   * bạn nên gọi supplierService.getCurrentSupplier() ở trang Profile,
   * không phải ở đây.
   */
  ...
  return (
    <AuthContext.Provider value={value}>
       {/* {!isLoading ? children : <GlobalSpinner />} */}
      {children}
