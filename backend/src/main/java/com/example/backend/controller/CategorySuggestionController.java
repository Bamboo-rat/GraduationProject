...
public class CategorySuggestionController {
    ...
    public ResponseEntity<ApiResponse<Page<CategorySuggestionResponse>>> getAllSuggestions(
        ...
        log.info("GET /api/category-suggestions - Admin viewing suggestions. Status: {}, Page: {}, Size: {}, Sort: {}",
    ...
    public ResponseEntity<ApiResponse<Page<CategorySuggestionResponse>>> getMySuggestions(
        ...
        log.info("GET /api/category-suggestions/my-suggestions - Supplier: {}, Status: {}, Page: {}, Size: {}, Sort: {}",
                keycloakId, status, pageable.getPageNumber(), pageable.getPageSize(), pageable.getSort());
